...
static std::map<std::string, TriangleFunctions<Index, Counter, TLR>> name_to_function = {
    ...
    {"ei_u6",  TriangleFunctions(eu6::edge_iterator<Index, Counter, TLR>, get_dummy_helper<Index, Counter>, free_dummy_helper<Index, Counter>)},
    {"ei_u7",  TriangleFunctions(eu7::edge_iterator<Index, Counter, TLR>, get_dummy_helper<Index, Counter>, free_dummy_helper<Index, Counter>)},
    {"ei_m1",  TriangleFunctions(em1::edge_iterator<Index, Counter, TLR>, get_dummy_helper<Index, Counter>, free_dummy_helper<Index, Counter>)},
