...
static std::map<std::string, TriangleFunctions<Index, Counter, TLR>> name_to_function = {
    ...
    {"ei_v4",  TriangleFunctions(ei4::edge_iterator<Index, Counter, TLR>, get_dummy_helper<Index, Counter>, free_dummy_helper<Index, Counter>)},
    ...
    {"ei_vec6",  TriangleFunctions(e_vec5::edge_iterator<Index, Counter, TLR>, get_dummy_helper<Index, Counter>, free_dummy_helper<Index, Counter>)},
...
void run(const BenchParams &params, std::ofstream &out_file) {
    ...
    std::cout << "HASH_TOTAL_SIZE = " << HASH_TOTAL_SIZE << std::endl;
