...
./clustered_bar_old.sh -c $COMMIT -w 0 -r 1 -p 1 -n 1 -l $ALGO -g GERMAN_ROAD_NETWORK,COMP_SCIENCE_AUTHORS,GOOGLE_CONTEST,HEP_LITERATURE,WWW_NOTRE_DAME,US_PATENTS
cd ../data
rm -r $COMMIT*
cd ../RUNEXP
