#ifndef TEAM02_HASH_TABLE_V3_H
#define TEAM02_HASH_TABLE_V3_H
...
static_assert(sizeof(InstrumentedIndex) * HASH_ITEM_SIZE == sizeof(mi), "Index number[HASH_ITEM_SIZE]");
...
//        c++;
        ...
        mi vec = mm_load((__m256i const *) head->number);
